...
images: ["header.webp"]
headerCredit: "Quelle: [TTN Mapper](https://ttnmapper.org), Kartendaten © [OpenStreetMap-Mitwirkende](https://www.openstreetmap.org/copyright)"
...
![Karte des TTN Mappers mit den Funkverbindungen des Gateways am Klinikum Vest in Recklinghausen; die Reichweite bis Dorsten beträgt etwa 19 km](gateways-2019.webp "Mai 2019: ein Gateway am Klinikum Vest, Recklinghausen – Reichweite bis Dorsten ca. 19 km. Quelle: [TTN Mapper](https://ttnmapper.org), Kartenkacheln von Stamen Design ([CC BY 3.0](https://creativecommons.org/licenses/by/3.0/deed.de)), Kartendaten © [OpenStreetMap-Mitwirkende](https://www.openstreetmap.org/copyright).")
...
![Karte des TTN Mappers für September 2021: Die Funkverbindungen überdecken die Region zwischen Dorsten, Datteln, Gladbeck und Castrop-Rauxel fast vollständig](gateways-2021.webp "September 2021: rund 85 ELTN-Gateways – die Funkverbindungen decken die Region nahezu flächendeckend ab. Quelle: [TTN Mapper](https://ttnmapper.org), Kartendaten © [OpenStreetMap-Mitwirkende](https://www.openstreetmap.org/copyright).")
...
![Karte von Sensor.Community im Raum Bottrop: farbige Waben zeigen die PM2.5-Werte der einzelnen Sensoren, links eine Farbskala von 0 bis 500 µg/m³](sensor-community-karte.webp "Kartendarstellung der Sensoren über Sensor.Community (luftdaten.info). Quelle: Kartendaten © [OpenStreetMap-Mitwirkende](https://www.openstreetmap.org/copyright).")
...
![openSenseMap mit den Bottroper Stationen auf der Stadtkarte; rechts die aktuellen Werte von sensor-07 aus der Gruppe Bottrop-Feinstaub](opensensemap.webp "Bottroper ELTN-Sensoren auf der openSenseMap – mit Download-Option für Rohdaten. Quelle: Kartendaten © [OpenStreetMap-Mitwirkende](https://www.openstreetmap.org/copyright).")
