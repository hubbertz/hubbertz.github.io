...
![Kameraaufnahme eines Hammers in Lobe, beschriftet mit dem Label „Hammer“](lobe-hammer-aufnahme.webp "Aufnahme über die Kamera: Jedes Bild erhält direkt sein Label.")
...
![Lobe beim Training: Das Kamerabild eines Hammers mit den Label-Vorschlägen Hammer und Pinzette](lobe-training.webp "Training: 100 % der Bilder werden korrekt vorhergesagt.")

Im Modus *Use* ordnet das Modell neue Kamerabilder in Echtzeit zu:

![Lobe im Modus Use: Die Pinzette im Kamerabild wird korrekt als „Pinzette“ erkannt](lobe-pinzette-erkannt.webp "Live-Erkennung: Die Pinzette wird korrekt erkannt, die Vorhersage lässt sich bestätigen oder verwerfen.")
...
![Aufnahme des Siebenzylinder-Sternmotor-Modells in Lobe](lobe-sternmotor.webp "Aufnahme des Sternmotor-Modells als Trainingsbild.")
...
![Lobe-Projektübersicht mit drei Modellen: Makroaufnahme eines roten 3-D-Drucks (100 % korrekt), Sternmotor (98 %) und Bauteil (98 %)](lobe-projekte.webp "Projektübersicht in Lobe: drei trainierte Modelle mit 98–100 % korrekten Vorhersagen.")
